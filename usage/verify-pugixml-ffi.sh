...
#
# 项目特征：
#   - 单个 src/pugixml.cpp（包含完整实现 + pugixml.hpp 头），重度使用 C++ 特性
#   - 拥有大量成员函数的类（xml_document / xml_node / xml_attribute 等）
#   - 经典的「单 cpp 多类」项目代表，验证工具对大型 C++ 翻译单元的处理能力
#
# 流程总览与 verify-tinyxml2-ffi.sh 同构（详见该脚本注释）。
# =============================================================================
