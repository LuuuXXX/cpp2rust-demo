#!/usr/bin/env bash
# =============================================================================
# verify-magic-enum-ffi.sh — 用途：验证 cpp2rust-demo 对 magic_enum 的 FFI 生成能力
# 项目特征：header-only（include/magic_enum/magic_enum.hpp 单文件），重度 constexpr
...
INCLUDE_DIRS=( "${SUBMODULE_REL}/include" "${SUBMODULE_REL}/example" )
