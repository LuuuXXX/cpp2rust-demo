mod common;
use common::{cargo_build, rust_hicc_dir};

macro_rules! compile_test {
    ($name:ident, $example:literal) => {
        #[test]
        fn $name() {
            let dir = rust_hicc_dir($example);
            cargo_build(&dir).unwrap_or_else(|e| panic!("{}", e));
        }
    };
}
...
compile_test!(compile_009_class_move, "009_class_move");
compile_test!(compile_010_class_static, "010_class_static");
compile_test!(compile_011_class_const, "011_class_const");
compile_test!(compile_012_class_volatile, "012_class_volatile");
...
compile_test!(compile_020_friend_function, "020_friend_function");
...
compile_test!(compile_031_custom_deleter, "031_custom_deleter");
compile_test!(compile_032_placement_new, "032_placement_new");
compile_test!(compile_033_raii_pattern, "033_raii_pattern");
...
compile_test!(compile_039_lambda_basic, "039_lambda_basic");
compile_test!(compile_040_std_function, "040_std_function");
compile_test!(compile_041_functional_bind, "041_functional_bind");
...
compile_test!(compile_045_union_basic, "045_union_basic");
compile_test!(compile_046_constexpr_basic, "046_constexpr_basic");
