...
compile_test_ignore!(compile_027_template_instantiation, "027_template_instantiation");
...
compile_test_ignore!(compile_032_placement_new, "032_placement_new");
...
compile_test_ignore!(compile_036_string_basic, "036_string_basic");
compile_test!(compile_037_array_basic, "037_array_basic");
compile_test_ignore!(compile_038_tuple_basic, "038_tuple_basic");
...
compile_test_ignore!(compile_047_noexcept_basic, "047_noexcept_basic");
