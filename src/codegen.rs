...
pub fn render_ffi(decls: &ExtractedDecls, link_name: &str, header_path: &str) -> String {
    ...
    writeln!(out, "// Source header : {}", header_path).unwrap();
...
fn sanitize_ident(name: &str) -> &str {
    match name {
        ...
        | "loop" | "match" | "if" | "else" | "return" | "break" | "continue" | "where"
        | "for" | "while" | "in" | "as" | "crate" | "self" | "super" | "trait" | "struct"
        | "enum" | "union" | "extern" | "unsafe" | "async" | "await" | "dyn" | "box"
        | "abstract" | "become" | "final" | "override" | "priv" | "typeof" | "unsized"
        | "virtual" | "yield" | "do" | "try" | "macro" => "value",
        other => other,
    }
}
...
pub fn render_interface_report(decls: &ExtractedDecls, link_name: &str, header: &str) -> String {
    ...
    writeln!(out, "|-------|-------|").unwrap();
    writeln!(out, "| Header | `{}` |", header).unwrap();
