...
hicc::import_lib! {
    ...
    fn processor_set_double(p: *mut Processor);
    ...
    fn multi_callback_add_double(mc: *mut MultiCallback);

    #[cpp(func = "void multi_callback_add_triple(MultiCallback*)")]
    fn multi_callback_add_triple(mc: *mut MultiCallback);
