...
```rust
// 友元函数在 Rust FFI 中就是普通函数
#[cpp(func = "int friend_function_getSum(struct MyClass*, struct MyClass*)")]
unsafe fn friend_function_getSum(a: *mut MyClass, b: *mut MyClass) -> i32;
```
