...
hicc::import_lib! {
    ...
    #[cpp(func = "void swap_int(int* a, int* b)")]
    fn swap_int(a: *mut i32, b: *mut i32);

    #[cpp(func = "void swap_double(double* a, double* b)")]
    fn swap_double(a: *mut f64, b: *mut f64);

    #[cpp(func = "void swap_char(char* a, char* b)")]
    fn swap_char(a: *mut i8, b: *mut i8);

    #[cpp(func = "void swap_int_array(int* arr, int i, int j)")]
    fn swap_int_array(arr: *mut i32, i: i32, j: i32);

    #[cpp(func = "int get_int_array(int* arr, int idx)")]
    fn get_int_array(arr: *mut i32, idx: i32) -> i32;

    #[cpp(func = "void set_int_array(int* arr, int idx, int value)")]
    fn set_int_array(arr: *mut i32, idx: i32, value: i32);
}
