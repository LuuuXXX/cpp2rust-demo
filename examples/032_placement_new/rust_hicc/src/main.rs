...
hicc::import_class! {
    ...
    class Buffer {
        ...
        fn data(&mut self) -> *mut std::ffi::c_void;
        ...
        fn construct(&mut self, offset: usize) -> *mut std::ffi::c_void;
    }
...
hicc::import_lib! {
    ...
    class Buffer;
    #[cpp(func = "Buffer* buffer_new(size_t capacity)")]
    fn buffer_new(capacity: usize) -> *mut Buffer;
    #[cpp(func = "void buffer_delete(Buffer* self_)")]
    unsafe fn buffer_delete(self_: *mut Buffer);

    class VectorBuffer;
    #[cpp(func = "VectorBuffer* vector_buffer_new(size_t capacity)")]
    fn vector_buffer_new(capacity: usize) -> *mut VectorBuffer;
    #[cpp(func = "void vector_buffer_delete(VectorBuffer* self_)")]
