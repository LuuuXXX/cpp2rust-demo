//! Precomputed powers of 10 for fast decimal scaling.
//!
//! Mirrors `internal::Pow10(int n)` from RapidJSON's pow10.h, but
//! only exposes a Rust function over a static table.

#[must_use]
pub fn pow10(n: i32) -> f64 {
    // 10^0..10^308
    const POW10: [f64; 309] = [
        1.0,
