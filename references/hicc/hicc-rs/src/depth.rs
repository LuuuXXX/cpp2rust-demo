pub trait Depth: Sized + 'static {
    type Next: Depth;
}

pub trait Depth0_4: Sized + 'static {}
pub trait Depth1_4: Sized + 'static {}
pub trait Depth2_4: Sized + 'static {}
pub trait Depth3_4: Sized + 'static {}
pub trait Depth4_4: Sized + 'static {}
pub trait Depth0_3: Sized + 'static {}
pub trait Depth0_2: Sized + 'static {}
pub trait Depth0_1: Sized + 'static {}
pub trait Depth0_0: Sized + 'static {}
